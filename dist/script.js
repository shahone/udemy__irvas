...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])('.decoration_slider', '.no_click', '.no_click', '.decoration_content > div > div', 'after_click');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])('.balcon_icons', '.balcon_icons_img', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block');
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["checkNumInputs"])('#width');
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["checkNumInputs"])('#height');
...
var forms = function forms(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["checkNumInputs"])('input[name="user_phone"]'); // сброс форм
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.appendChild(statusMessage); // собираем данные
        ...
        return regeneratorRuntime.async(function postData$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                document.querySelector('.status').textContent = message.loading; //фетч отправляет данные на сервер. происходит обработка, а на это нужно время. код не ждет - работает дальше.
...
var modals = function modals() {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // autoModal('popup', 60000);
};
...
var tabs = function tabs(headerSelector, tabSelector, tabLink, contentSelector, activeClass) {
